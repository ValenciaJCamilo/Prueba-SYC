    ...
    <section class="general-container">
        <div class="overview-general">
            ...
            <div class="new-record-container">
                ...
                <a class="btn-add-record btn-gestionClientes" title="Ir a sección de clientes" href="./clientes-view.php">
                    <i class="uil uil-user"></i>Gestión de clientes
                </a>
                <a class="btn-add-record btn-reporteValores" title="Mostrar reporte total" href="./reporte-view.php">
                    <i class="uil uil-file-graph"></i>Reporte completo
                </a>
            </div>
            <!--MODAL CREAR-->
            <input type="checkbox" id="btn-modal-add-record">
                ...
                <div class="title-info">
                    ...
                    <form action="./consultas/crearFactura.php" method="POST" data-form="save" autocomplete="off">
                        <div class="input-field">
                            <input name="documento" type="number" placeholder="Número de documento del cliente*" pattern="[0-9]+" title="Por favor, complete el campo"   />
                        </div>
                        <div class="input-field">
                            <input name="valor" type="number" placeholder="Valor *" pattern="[0-9]+" title="Por favor, complete el campo con un número entero positivo" >
                        </div>
                        <div class="input-field ">
